...
@Module({
  ...
  TypeOrmModule.forRoot({
    ...
    entities: [User, Message, MeditationTechnique, Média, Forum,  Comment],
    synchronize: false,
    logging: false,
  }),
 
  UserModule, MessageModule, MédiaModule, MeditationTechniqueModule, ForumModule,  AuthModule, ChatGateway, CommentModule],
